    ...
    <section className="relative z-10 py-24 border-y border-white/5 bg-white/[0.02]">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {/* Câmbio Convencional Card */}
          <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-8 transition-all hover:bg-red-500/10">
          ...
          {/* OTC with Stablecoins Card */}
          <div className="rounded-2xl border border-green-500/20 bg-green-500/5 p-8 ring-2 ring-green-500/20 transition-all hover:bg-green-500/10">
            <div className="mb-6 flex items-center gap-3">
