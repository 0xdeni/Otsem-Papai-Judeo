      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-2 max-w-6xl mx-auto">
            <motion.div
              ...
              className="liquid-glass rounded-[3rem] p-12 border-red-500/10 hover:border-red-500/30 transition-all duration-500"
            >
              ...
              <ul className="space-y-6">
                {traditionalItems.map((item, index) => (
                  <li key={index} className="flex items-center justify-between py-3 border-b border-black/[0.03] last:border-0">
                    <span className="text-[15px] font-semibold text-muted-foreground">{item.label}</span>
                    <div className="flex items-center gap-3">
                      <span className="text-[15px] font-black text-red-600">{item.value}</span>
            ...
            <motion.div
              ...
              className="relative liquid-glass rounded-[3rem] p-12 border-emerald-500/20 bg-emerald-500/[0.03] shadow-2xl shadow-emerald-500/5"
            >
              ...
              <ul className="space-y-6">
                {otcItems.map((item, index) => (
                  <li key={index} className="flex items-center justify-between py-3 border-b border-emerald-500/10 last:border-0">
                    <span className="text-[15px] font-semibold text-muted-foreground">{item.label}</span>
                    <div className="flex items-center gap-3">
                      <span className="text-[15px] font-black text-emerald-600">{item.value}</span>
